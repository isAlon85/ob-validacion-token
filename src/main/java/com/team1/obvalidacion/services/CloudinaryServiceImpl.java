...
//        String username = jwtTokenUtil.getUsernameFromToken(authToken);
    ...
    public boolean deleteFrontId(String id) throws IOException {
        if (frontIdRepository.existsByCloudinaryId(id)) {
            //Connecting picture with proper User
...
//        String username = jwtTokenUtil.getUsernameFromToken(authToken);
    ...
    public boolean deleteBackId(String id) throws IOException {
        if (backIdRepository.existsByCloudinaryId(id)) {
            //Connecting picture with proper User
